...
function Register() {
  ...
  const onUserRegister = async (userObj) => {
    ...
    try {
      ...
      let res = await axios.post("https://capstone-project-1fpf.onrender.com/auth/users", formData, { withCredentials: true });
    ...
    <div className={`${pageBackground} flex items-center justify-center py-16 px-4`}>
      <div className={formCard}>
        ...
        <form onSubmit={handleSubmit(onUserRegister)}>
          ...
          <button
            type="submit"
            className="w-full bg-[#b55239] text-white font-semibold py-2.5 rounded-full hover:bg-[#933f2d] transition-colors cursor-pointer mt-2 text-sm tracking-tight"
          >
            Create Account
          </button>
        </form>
        ...
        <p className={`${mutedText} text-center mt-5`}>
          ...
          <NavLink to="/login" className="text-[#b55239] font-medium">
            Sign in
          </NavLink>
        </p>
      </div>
