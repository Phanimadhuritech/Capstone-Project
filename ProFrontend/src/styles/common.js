...
// Theme: Custom Light — white/f5f5f7 background, #1d1d1f text, #D49E8D accent
...
export const linkClass = "text-[#D49E8D] hover:text-[#b87f6d] transition-colors";

// ─── Buttons ──────────────────────────────────────────
export const primaryBtn =
  "bg-[#D49E8D] text-white font-semibold px-5 py-2 rounded-full hover:bg-[#b87f6d] transition-colors cursor-pointer text-sm tracking-tight";
...
export const ghostBtn = "text-[#D49E8D] font-medium hover:text-[#b87f6d] transition-colors cursor-pointer text-sm";
...
export const inputClass =
  "w-full bg-white border border-[#d2d2d7] rounded-xl px-4 py-2.5 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#D49E8D] focus:ring-2 focus:ring-[#D49E8D]/10 transition";
export const formGroup = "mb-4";
export const submitBtn =
  "w-full bg-[#D49E8D] text-white font-semibold py-2.5 rounded-full hover:bg-[#b87f6d] transition-colors cursor-pointer mt-2 text-sm tracking-tight";
...
export const navLinkActiveClass = "text-2xl text-[#D49E8D] font-medium";
...
export const tagClass = "text-[0.65rem] font-semibold text-[#D49E8D] uppercase tracking-widest w-fit";

// ─── Article Page ─────────────────────────────────────
export const articlePageWrapper = "max-w-3xl mx-auto px-6 py-14";
export const articleHeader = "mb-10 flex flex-col gap-4";
export const articleCategory = "text-[0.7rem] font-semibold uppercase tracking-widest text-[#D49E8D]";
...
export const editBtn = "bg-[#D49E8D] text-white text-sm px-4 py-2 rounded-full hover:bg-[#b87f6d] transition";
...
export const loadingClass = "text-[#D49E8D]/60 text-sm animate-pulse text-center py-10";
...
export const avatar =
  "w-9 h-9 rounded-full bg-[#D49E8D]/10 text-[#D49E8D] flex items-center justify-center text-sm font-semibold";
